...
class Board:
    def __init__(self, dim_size, num_bombs):
        ...
        # we'll put (row,col) tuples into this set
        self.dug = set() # if we dig at 0,0, then self.dug = {(0,0)}

    def make_new_board(self):
        # construct a new board based on the dim size and num bombs
        # we should construct the lists here (or whatever representation you prefer,
    ...
    def __str__(self):
        ...
        # first let's create a new arrway that represents what user would see
...
def play(dim_size=10, num_bombs=10):
    ...
    # Step 3b: If location is not a bomb, dig until each sqaure is at least next to a bomb
